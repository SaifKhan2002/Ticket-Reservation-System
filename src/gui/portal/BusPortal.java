...
import reservation.transport.Bus;

public class BusPortal extends JFrame {
    // Panel
    ...
    private BusCustomers railwayCustomers;
    ...
    public
     ...
     BusPortal() {
        // it is for the title
        super("Bus Portal");
        railwayCustomers = new BusCustomers();
        ...
        destinLabel.setForeground(Color.RED);
        ...
        ///
        classLabel = new JLabel(" Bus Class");
        ...
        generateReceipt.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                dispose();
                new Receipt(railwayCustomers, bus);
            }
        });
